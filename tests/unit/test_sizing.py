...
def test_greedy_fill_under_limited_cash() -> None:
    ...
    trades, gross, lev = size_orders(drifts, prices, cash=200.0, net_liq=net_liq, cfg=cfg)
...
def test_rounds_and_drops_orders_below_min() -> None:
    ...
    trades, gross, lev = size_orders(drifts, prices, cash=600.0, net_liq=net_liq, cfg=cfg)
...
def test_duplicate_symbols_are_merged() -> None:
    ...
    trades, _gross, _lev = size_orders(drifts, prices, cash=500.0, net_liq=net_liq, cfg=cfg)
